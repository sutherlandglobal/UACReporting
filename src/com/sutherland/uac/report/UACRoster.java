 ...
 *
 */
public final class UACRoster extends Roster implements Attributes, Scheduling
{
	
	private final String dbPropFile = DatabaseConfigs.PRIVATE_LABEL_PROD_DB;

	private final static String PROGRAM_NAME = "UAC";

	private final static String ORGUNIT_NAME = "NATS";
	
	private final static Logger logger = Logger.getLogger(UACRoster.class);
	 ...
	 */
	public UACRoster() throws ReportSetupException 
	{
		super();
	}
	...
	protected boolean setupReport() 
	{
		...
		try
		{
			reportName = UACRoster.uiGetReportName();
			reportDesc = UACRoster.uiGetReportDesc();
